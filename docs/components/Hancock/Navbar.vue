      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="items-center hidden md:ml-6 md:flex md:space-x-8">
            <BaseDropdown
              :paths="['dropdown', 'icon', 'input', 'radio', 'select', 'button']"
            >{{ $t('elements') }}</BaseDropdown>
            <BaseDropdown :paths="['projects']">{{ $t('patterns') }}</BaseDropdown>
            <BaseDropdown :paths="['projects', 'users']">{{ $t('templates') }}</BaseDropdown>
            <BaseDropdown :paths="['footers', 'headers', 'navbars', 'wrappers']">{{ $t('layout') }}</BaseDropdown>
          </div>
        </div>
