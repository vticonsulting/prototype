      ...
      <ul class="-my-5 divide-y divide-gray-200">
        <li class="py-5">
          <div class="relative focus-within:ring-2 focus-within:ring-cyan-500">
            ...
            <p class="mt-1 text-sm text-gray-600 line-clamp-2">
              Cum qui rem deleniti. Suscipit in dolor veritatis sequi aut. Vero
              ut earum quis deleniti. Ut a sunt eum cum ut repudiandae possimus.
        ...
        <li class="py-5">
          <div class="relative focus-within:ring-2 focus-within:ring-cyan-500">
            ...
            <p class="mt-1 text-sm text-gray-600 line-clamp-2">
              Alias inventore ut autem optio voluptas et repellendus. Facere
              totam quaerat quam quo laudantium cumque eaque excepturi vel.
              Accusamus maxime ipsam reprehenderit rerum id repellendus rerum.
              Culpa cum vel natus. Est sit autem mollitia.
            </p>
          </div>
        </li>
        ...
        <li class="py-5">
          <div class="relative focus-within:ring-2 focus-within:ring-cyan-500">
            ...
            <p class="mt-1 text-sm text-gray-600 line-clamp-2">
              ...
              et recusandae. Alias consectetur voluptatibus. Accusamus a ab
